...
import '../../../Help&SupportScreen/help_support_screen.dart';
import '../../../ProfileInformationScreen/profile_information.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSettingsSection(
              'Notifications',
              [
                _buildSwitchItem('🔔', 'Push Notifications', 'Enable/disable all notifications', _notificationsEnabled, (v) => setState(() => _notificationsEnabled = v)),
                _buildSwitchItem('📦', 'Order Updates', 'Get notified about order status', _orderUpdates, (v) => setState(() => _orderUpdates = v)),
                _buildSwitchItem('🎉', 'Promotional Offers', 'Receive offers and discounts', _promotionalNotifications, (v) => setState(() => _promotionalNotifications = v)),
                _buildSwitchItem('⏰', 'Medicine Reminders', 'Medication reminder alerts', _reminderNotifications, (v) => setState(() => _reminderNotifications = v)),
              ],
            ),
            ...
            _buildSettingsSection(
              ...
              [
                ...
                _buildDropdownItem('🌐', 'Language', _selectedLanguage, ['English', 'Hindi', 'Gujarati'], (v) => setState(() => _selectedLanguage = v!)),
                _buildDropdownItem('💰', 'Currency', _selectedCurrency, ['INR (₹)', 'USD (\$)', 'EUR (€)'], (v) => setState(() => _selectedCurrency = v!)),
            ...
            _buildSettingsSection(
              'Support',
              [
                _buildSettingsItem('❓', 'Help Center', 'FAQs and support articles',
            ...
            child: Column(
              children: items.asMap().entries.map((entry) {
                ...
                return Column(
                  children: [
                    item,
                    if (!isLast) Divider(height: 1, color: Color(0xFFF3F4F6)),
                  ],
                );
              }).toList(),
            ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 15),
          Expanded(
            child: Text(title, style: TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF111827))),
          ),

...
import 'product_details_page1.dart';
...
class _SearchScreensState extends State<SearchScreens> {
  final List<Medicine> medicines = [
    ...
    Medicine(
      ...
      emoji: '💊',
      description:
          'Calpol 650mg is used to relieve fever, headache,'
    ...
    Medicine(
      ...
      emoji: '💊',
      description:
          'Azithromycin 250mg is an antibiotic used to treat '
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [filterButton("All"), const SizedBox(width: 8), filterButton("OTC"), const SizedBox(width: 8), filterButton("Prescription")],
            ),
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        leading: Container(
                          ...
                          child: Padding(padding: const EdgeInsets.all(7), child: Text("💊", style: TextStyle(fontSize: 30))),
                        ),
  ...
  Widget filterButton(String label) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(label, style: TextStyle(color: isSelected ? Colors.blue : Colors.black54, fontWeight: FontWeight.w600)),
      ),
    );
  }
}

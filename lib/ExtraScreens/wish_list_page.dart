      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            ...
            child: const Padding(padding: EdgeInsets.only(right: 10), child: Icon(Icons.shopping_cart, color: Colors.white)),
          ),
        ],
      ...
      body: Padding(
        ...
        child: Obx(() {
          if (wishlistController.wishlist.isEmpty) {
            return const Center(child: Text("No items in wishlist", style: TextStyle(color: Colors.black54)));
          }
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("${wishlistController.wishlist.length} items in wishlist", style: const TextStyle(color: Colors.black54)),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Center(child: Text(product.image, style: const TextStyle(fontSize: 35))),
                            ),

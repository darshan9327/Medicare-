...
class MyAddressesScreen1 extends StatefulWidget {
  const MyAddressesScreen1({super.key});

  @override
  State<MyAddressesScreen1> createState() => _MyAddressesScreen1State();
}

class _MyAddressesScreen1State extends State<MyAddressesScreen1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(
        title: 'My Addresses',
        actions: [IconButton(onPressed: () => _showAddAddressDialog(context), icon: Icon(Icons.add))],
      ),
      body: Padding(
                            ...
                            children: [
                              ...
                              if (address['isDefault']) ...[
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(color: Color(0xFFDCFCE7), borderRadius: BorderRadius.circular(12)),
                                ...
                                itemBuilder:
                                    (BuildContext context) => <PopupMenuEntry<String>>[
                                      PopupMenuItem<String>(
                                        value: 'edit',
                                        child: Row(
                                          children: [Icon(Icons.edit, size: 18, color: Color(0xFF6B7280)), SizedBox(width: 8), Text('Edit')],
                                        ),
                                      ),
                                      if (!address['isDefault'])
                                        PopupMenuItem<String>(
          ...
          (context) => Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Container(width: 40, height: 4, decoration: BoxDecoration(color: Color(0xFFE5E7EB), borderRadius: BorderRadius.circular(2))),
                  SizedBox(height: 20),

...
class ProfileInformation1 extends StatefulWidget {
  const ProfileInformation1({super.key});

  @override
  State<ProfileInformation1> createState() => _ProfileInformation1State();
}

class _ProfileInformation1State extends State<ProfileInformation1> {
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items:
                      ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'].map((String value) {
                        return DropdownMenuItem<String>(value: value, child: Text(value));
                      }).toList(),
                  onChanged: (String? newValue) {
                    setState(() {
  ...
  Widget _buildFormField(String label, TextEditingController controller, IconData icon, {bool readOnly = false}) {
    return Container(
      ...
      child: TextFormField(
        ...
        readOnly: readOnly,
        decoration: InputDecoration(labelText: label, prefixIcon: Icon(icon, color: Color(0xFF6B7280)), border: InputBorder.none),
        validator: (value) {

...
class UploadPrescription extends StatefulWidget {
  ...
  const UploadPrescription({super.key, required this.product});
              ...
              children: [
                ...
                CommonContainer(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(SnackBar(content: Text("${widget.product.name} added to cart ✅"), duration: Duration(seconds: 1)));

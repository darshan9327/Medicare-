  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [IconButton(onPressed: () => _showUploadPrescriptionDialog(context), icon: Icon(Icons.upload_file))],
      ),
      body: Padding(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Spacer(),
                            TextButton(onPressed: () {}, child: Text('View Details', style: TextStyle(color: Color(0xFF2563EB)))),
                          ],
                        ),
                      ],
                    ),

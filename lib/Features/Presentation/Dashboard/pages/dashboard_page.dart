...
import '../../Profile/pages/profile_screen_page.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final List<Widget> _screens = [const HomeScreen(), SearchScreen(), ShoppingCart(showOwnAppBar: false), ProfileScreen()];
              ...
              children: [
                ...
                TextField(
                  decoration: InputDecoration(
                    prefixIcon: Padding(padding: const EdgeInsets.all(10), child: const Text("🔍", style: TextStyle(fontSize: 20))),
                ...
                const SizedBox(height: 20),
                const Text("Popular Medicines", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                const SizedBox(height: 12),
                ListView.builder(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        leading: Container(
                          ...
                          child: Padding(padding: const EdgeInsets.all(5), child: Text(med["emoji"], style: const TextStyle(fontSize: 35))),
                        ),

...
import 'package:medicare/Features/Presentation/Wishlist/widgets/wishlist_product_image.dart';
import 'package:medicare/Features/Presentation/Wishlist/widgets/wishlist_product_info.dart';
import '../../Product/pages/product_details_page.dart';

class WishlistItemTile extends StatelessWidget {
  final Product1 product;

  const WishlistItemTile({super.key, required this.product});
